...
group :development do
  ...
  gem 'better_errors'
  gem 'binding_of_caller' # Necessary to user Better Error's advanced features

  # Automates various tasks by running custom rules whenever file or directories are modified
  gem 'guard'
